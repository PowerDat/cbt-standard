        ...
        <div class="row">
            <div class="col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">{{'ด้าน '.$part->part_order.' '.$part->part_name}}</li>
                    <li class="breadcrumb-item active">{{'เป้าประสงค์ '.$part_target[0]->part_target_order.' '.$part_target[0]->part_target_name}}</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="stepwizard">
                        <div class="stepwizard-row setup-panel">
                            ...
                            <div class="stepwizard-step">
                                <a class="btn btn-primary" href="#step-{{$item->part_target_sub_order}}">{{$item->part_target_sub_order}}</a>
                            </div>
                            @endforeach
                            {{-- <div class="stepwizard-step">
