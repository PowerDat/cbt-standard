                    ...
                    <div class="card-body">
                        ...
                        <fieldset>
                            <div class="row">
                                ...
                                {{-- <input type="hidden" name="part_id" id="part_id" value="{{ isset($part_id) ? $part_id : ''}}"> --}}
                            </div>
                        ...
                        <fieldset>
                            <table class="table table-bordered">
                                ...
                                <tbody id="tbody_part_target_sub"></tbody>
                            </table>
