        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <a class="btn btn-light" href="{{route('report.committee.index')}}">
                                ชุมชนที่ประเมิน
                            </a>
                            <a class="btn btn-primary active" href="{{route('report.committee.summary')}}">
                                สรุปผลการประเมิน
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="print_setion">
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="6"><strong>ชื่อชุมชน</strong> {{ $user_evaluate[0]->community_name }}</td>
                                </tr>
                                <tr>
