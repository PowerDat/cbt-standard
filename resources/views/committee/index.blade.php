            ...
            <div class="card">
                ...
                <div class="card-header text-end">
                    <div class="col-sm-9 offset-sm-3">
                        <a href="{{route('committee.create')}}" class="btn btn-primary">เพิ่มข้อมูล</a>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"> 
                                        <a href="{{route('committee.change-password', $item->id)}}" class="btn btn-light">
                                            <i class="fa fa-key"></i>
                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{route('committee.edit', $item->id)}}" class="btn btn-primary ">
